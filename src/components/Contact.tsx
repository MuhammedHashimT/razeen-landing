...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappUrl = `https://wa.me/919746822548?text=${encodeURIComponent(message)}`;
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gray-600">Darul Huda Islamic University</div>
                  <div className="text-gray-600">Kerala, India</div>
                </div>
              </div>
            </div>
          </div>
